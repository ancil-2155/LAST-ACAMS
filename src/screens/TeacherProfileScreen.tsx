...
const TeacherProfileScreen = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = firestore()
      ...
      .onSnapshot(
        ...
        error => {
          console.log('Teacher profile load failed:', error);
          setLoading(false);
        },
      );
  ...
  const name = userData?.name || auth().currentUser?.displayName || 'Teacher';
  const photoUrl =
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.detailsCard}>
        ...
        <InfoRow label="Year Incharge" value={userData?.year} />
        <InfoRow label="Approval Status" value={userData?.approved ? 'Approved' : 'Pending'} />
      </View>
    </ScrollView>
  );
};
